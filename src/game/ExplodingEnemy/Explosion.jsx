...
export default function Explosion({
  ...
  useEffect(() => {
    ...
    world.intersectionsWithShape(position, rotation, sphere, (collider) => {
    ...
    bodiesToAffect.forEach((rb) => {
      ...
      const rbTranslationVec = new Vector3(
        rbTranslation.x,
        rbTranslation.y,
        rbTranslation.z,
      );

      const force = rbTranslationVec
        .clone()
        .sub(position)
        .normalize()
        .multiplyScalar(FORCE_MAGNITUDE);
